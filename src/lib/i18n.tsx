...
const en: Dict = {
  ...
  "onboarding.step3.body": "The AI tab recommends a layout, palette and font pair for your subject.",
  "onboarding.step4.title": "Download or print",
  "onboarding.step4.body": "Export a print-ready A4 PDF or high-res PNG. Works fully offline once installed.",
